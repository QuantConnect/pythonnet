                    ...
                    if (clrtype != null)
                    {
                        ...
                        if ((pi[paramIndex].ParameterType != typeof(object)) && (pi[paramIndex].ParameterType != clrtype))
                        {
                            ...
                            if (!typematch)
                            {
                                ...
                                var underlyingType = Nullable.GetUnderlyingType(pi[paramIndex].ParameterType);
                                if (underlyingType == null)
                                {
                                    underlyingType = pi[paramIndex].ParameterType;
                                }
                                ...
                                var opImplicit = pi[paramIndex].ParameterType.GetMethod("op_Implicit", new[] { clrtype });
                                if (opImplicit != null)
                                {
                                    typematch = opImplicit.ReturnType == pi[paramIndex].ParameterType;
                                    clrtype = pi[paramIndex].ParameterType;
                                }
                            }
                            Runtime.XDecref(pyoptype);
